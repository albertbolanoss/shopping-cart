...
public class AddUserReqMother {
    ...
    public static AddUserReq invalidMaxLength() {
        return new AddUserReq()
                .firstName(FakerMother.getFaker().lorem().characters(UserDomainMother.FIRSTNAME_MAX_LENGTH + 1))
                .lastName(FakerMother.getFaker().lorem().characters((UserDomainMother.LASTNAME_MAX_LENGTH + 1)))
                .email(FakerMother.getFaker().lorem().characters((UserDomainMother.EMAIL_MAX_LENGTH + 1)))
                .phone(FakerMother.getFaker().lorem().characters((UserDomainMother.PHONE_MAX_LENGTH + 1)))
                .password(FakerMother.getFaker().lorem().characters((UserDomainMother.PASSWORD_MAX_LENGTH + 1)));
    }
